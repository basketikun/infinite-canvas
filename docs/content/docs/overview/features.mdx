...
- Optionally use a locally running Eagle library as an additional asset source. Eagle folders are shown in the asset page, canvas asset panel, picker, and Canvas Agent asset list alongside project-local assets.
- Save images, videos, and text to project-local storage, Eagle's uncategorized area, or a selected Eagle folder through the shared save-target flow. Eagle-backed assets can be edited and moved to Eagle's trash from the app.
