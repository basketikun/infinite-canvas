...
- If Eagle is installed locally, start Eagle before the frontend to expose its folders and assets as an optional second asset source. The project-local asset library remains available when Eagle is offline.
