...
See [SECURITY.md](https://github.com/JustinQiuck/dsh-freecanvas/blob/main/SECURITY.md). Do not post exploit details, private API keys, sensitive screenshots, or real user data in a public issue.

Use GitHub private vulnerability reporting or a Security Advisory. If neither option is available, open a public issue asking the maintainers to enable private reporting. Do not include vulnerability details in that issue.
