...
See [SECURITY.md](https://github.com/Zhanghoks/Research-canvas/blob/main/SECURITY.md). Do not post exploit details, private API keys, sensitive screenshots, or real user data in a public issue.

Use GitHub private vulnerability reporting or a Security Advisory. If unavailable, email [zhanghoks@gmail.com](mailto:zhanghoks@gmail.com) with `[coresearch security]` in the subject.
