...
const messages = {
  en: {
    eyebrow: 'Open-source research canvas',
    center: 'Documentation',
    description: 'A research canvas that brings research entities, frameworks, questions, notes, and an AI agent panel into one workflow.',
    quickStart: 'Quick Start',
    demo: 'Live Demo',
    gallery: 'Gallery',
    features: 'Explore Features',
    previewAlt: 'CoResearch preview',
  ...
  'zh-CN': {
    eyebrow: '开源研究画布工具',
    center: '文档中心',
    description: '面向研究工作流的画布，把研究实体、框架、问题、笔记和 AI Agent 面板放在同一个工作流里。',
    quickStart: '快速开始',
    demo: '在线体验',
    gallery: '效果展示',
    features: '功能介绍',
    previewAlt: 'CoResearch 效果图',
    contributors: '开发贡献者',
