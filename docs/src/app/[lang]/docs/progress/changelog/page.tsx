...
const messages = {
  en: {
    ...
    content: '# Changelog\n\nThe detailed changelog is currently maintained in Chinese. See the [project changelog](https://github.com/JustinQiuck/dsh-freecanvas/blob/main/CHANGELOG.md) for all releases.',
  },
  'zh-CN': {
    title: '更新日志',
