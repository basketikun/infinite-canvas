export default {
    ...
    agent: {
        ...
        connect: { title: "Network connection to Codex", description: "Enter the Agent URL and token. They are discovered automatically by default; fill them in only if discovery fails.", disconnect: "Disconnect", connect: "Connect", address: "Connection URL", urlPlaceholder: "For example http://127.0.0.1:17371", token: "Connection token", tokenPlaceholder: "Discover automatically or enter the Connect token" },
