export default {
    ...
    desktop: { credentialsFailed: "Could not read Windows Credential Manager", updateTitle: "Version {{version}} is available", updateDescription: "A new version is ready. Confirm to download it and restart the app.", updateNow: "Update and restart", updateLater: "Later" },
    common: {
        cancel: "Cancel",
        save: "Save",
        edit: "Edit",
    ...
    config: {
        ...
        exportSecurityTitle: "The exported file contains plaintext credentials",
        exportSecurityWarning: "The configuration file includes every provider API key and the WebDAV password. Store it only in a trusted location and do not upload or forward it.",
        ...
        preferences: {
            ...
            defaultAgentModel: "Agent text model",
        ...
        channelEditor: {
            ...
            httpWarning: "This is a non-local HTTP endpoint. The desktop app can access it, but API keys and request content are not encrypted in transit.",
