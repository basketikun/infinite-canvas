export default {
    ...
    assets: {
        ...
        movedToFolder: "Moved {{count}} item(s)",
        tagged: "Tagged {{count}} item(s) as “{{tag}}”",
        folder: {
            newFolder: "New folder",
            rename: "Rename folder",
            moveRoot: "Move to root",
            legacyTags: "Legacy canvas categories (by tag)",
        },
        ...
        deletedBulk: "Deleted {{count}} asset(s)",
        filesImported: "Imported {{count}} file(s)",
        filesSkipped: "Skipped {{count}} file(s)",
        dropUnsupported: "Unsupported file type (images / audio / video)",
        droppedSource: "Dropped in",
