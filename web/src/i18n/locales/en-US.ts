export default {
    ...
    canvas: {
        ...
        editors: {
            ...
            annotateTitle: "Annotate image", annotateHint: "Mouse wheel to zoom · middle button or Space + left drag to pan · Alt + left/right drag adjusts brush size · Ctrl/Cmd+Z to undo · Ctrl/Cmd+Shift+Z to redo", annotateColor: "Annotation color", saveAnnotate: "Save annotation", annotateRequired: "Draw on the image first", annotateFailed: "Failed to compose the annotated image", annotateUndoTitle: "Undo annotation (Ctrl/Cmd+Z)", annotateUndo: "Undo annotation", annotateRedoTitle: "Redo annotation (Ctrl/Cmd+Shift+Z)", annotateRedo: "Redo annotation",
