export default {
    ...
    canvas: {
        ...
        node: {
            node: "Node",
            untitled: "Untitled node", renameHint: "Double-click to rename the node", group: "Group", nodeCount: "{{count}} nodes", generating: "Generating", failed: "Generation failed", retry: "Retry", missingPlugin: "Plugin missing", missingPluginDescription: "The plugin for node type “{{type}}” is not installed or enabled", generateImage: "Generate image from text", generate: "Generate", editText: "Double-click to edit text", emptyImage: "Empty image node", emptyVideo: "Empty video node", emptyAudio: "Empty audio node", audio: "Audio", createCopy: "Create copy", setPrimary: "Set as primary", focusImages: "Focus images", focusHistory: "Focus history", exitCandidateMode: "Exit candidate selection", historyCount: "History {{count}}", prevItem: "Previous item", nextItem: "Next item", galleryDot: "Image {{index}} of {{count}}", galleryDotHistory: "History {{index}} of {{count}}", galleryDotCurrent: "Current draft, item {{index}} of {{count}}",
        },
        sidePanel: {
