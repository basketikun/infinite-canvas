export default {
    ...
    canvas: {
        ...
        emptyState: { title: "Start with a research question", description: "Put a fuzzy interest on the canvas, then shape it into directions, problems, methods, and a testable Idea.", seed: "Create a Seed", seedDescription: "Capture your initial research interest", text: "Add text", textDescription: "Write down material, observations, or notes", import: "Import material", importDescription: "Add images, video, or audio", agent: "Talk to the Agent", agentDescription: "Ask the Agent to help with the first step", hint: "You can also double-click empty canvas space to create a node" },
        project: {
    ...
    agent: {
        ...
        connect: { title: "Network connection to Codex", description: "When a local Canvas Agent is online, the panel discovers and connects automatically. Enter the URL and token only if that fails.", disconnect: "Disconnect", connect: "Connect", address: "Connection URL", urlPlaceholder: "For example http://127.0.0.1:17371", token: "Connection token", tokenPlaceholder: "Discover automatically or enter the Connect token" },
        ...
        panel: { connectionSettings: "Connection settings · {{status}}", connectionSettingsLabel: "Connection settings. Current status: {{status}}", chat: "Chat", connection: "Connection", settings: "Agent settings", settingsLabel: "Open Agent settings", settingsTitle: "Agent settings", history: "History", skills: "Skills", logs: "Logs", collapse: "Collapse chat", collapseLabel: "Collapse Agent panel", resize: "Resize right panel", content: "Agent content", mcpInitializing: "MCP is initializing. You can send messages when it is ready.", initFailed: "Codex conversation initialization failed. Start or resume a conversation.", placeholder: "Ask Codex, type / for Skills, or @ to reference canvas assets" },
        chat: { welcome: "Hello, {{name}}", welcomeDescription: "Start with the current research project and build it out on the canvas together.", latestMessages: "View latest messages", latestCall: "Latest call", input: "Input", cached: "Cached", output: "Output" },
    ...
    auth: { title: "Sign in to Research Canvas", account: "Account", password: "Password", signIn: "Sign in", signOut: "Sign out", signedIn: "Signed in", testAccountHint: "Built-in test account: test, password: 12345678", failed: "Authentication failed" },
    locale: {
        zhCN: "简体中文",
        enUS: "English",
    },
