export default {
    ...
    workbench: {
        ...
        noVideoModels: "None of your providers offer video models. fal.ai, Replicate, OpenAI (Sora) and Google (Veo) do.",
        addVideoProvider: "Add a video provider",
    ...
    config: {
        ...
        channels: {
            ...
            notConnected: "No API key - this provider's models are hidden from the studio",
        ...
        providers: {
            ...
            hints: {
                ...
                openai: "Sora 2 video, GPT Image, TTS",
                xai: "Grok Imagine video + image",
                replicate: "Kling, Seedance, Wan, MiniMax video",
                openrouter: "400+ models, one key for everything",
            },
        },
        preferences: {
            interface: "Interface",
        ...
        channelEditor: {
            ...
            modelDescription: "{{count}} models imported. Pick which one to use in the studio.",
            selectModels: "Select models",
            connect: "Connect",
            noAuth: "This provider needs no API key",
            noAuthHint: "For a local or self-hosted gateway that authenticates by IP, or not at all.",
            ...
            empty: "Press Connect to import this provider's models.",
            capabilities: {
                image: "Image",
                video: "Video",
                text: "Text",
