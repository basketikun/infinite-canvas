export default {
    ...
    canvas: {
        ...
        nodeTypes: { image: "Image", text: "Text", config: "Generation config", video: "Video", audio: "Audio", group: "Group", crEntity: "Research entity", frame: "Frame", note: "Note", question: "Question", pdf: "PDF", web: "Web" },
        researchNodes: {
        ...
        sidePanel: {
            ...
            filter: { image: "Image", video: "Video", text: "Text", audio: "Audio", config: "Configuration", group: "Group", cr_entity: "Research entity", frame: "Frame", note: "Note", question: "Question", pdf: "PDF", web: "Web" },
        },
    ...
    auth: { title: "Sign in to Research Canvas", email: "Email", password: "Password", signIn: "Sign in", signUp: "Sign up", signOut: "Sign out", signedIn: "Signed in", signedUp: "Sign-up submitted. Follow the email instructions to verify your account.", failed: "Authentication failed" },
    locale: {
        zhCN: "简体中文",
        enUS: "English",
    },
