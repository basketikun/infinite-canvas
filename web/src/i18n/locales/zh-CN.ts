export default {
    ...
    assets: {
        ...
        addTag: "加标签",
        deleteBulk: "删除所选",
        movedToFolder: "已移动 {{count}} 项",
        tagged: "已为 {{count}} 项加上「{{tag}}」标签",
        folder: {
            newFolder: "新建文件夹",
            rename: "重命名文件夹",
            moveRoot: "移回根目录",
            legacyTags: "旧画布分类（按标签）",
        },
        selectImage: "请选择图片文件",
        updated: "资产已更新",
        saved: "资产已保存",
        ...
        deleted: "资产已删除",
        deletedBulk: "已删除 {{count}} 个资产",
        filesImported: "已导入 {{count}} 个文件",
        filesSkipped: "跳过 {{count}} 个文件",
        dropUnsupported: "暂不支持的文件类型（支持图片 / 音频 / 视频）",
        droppedSource: "拖放入库",
        dropHere: "松开以导入",
