export default {
    ...
    agent: {
        ...
        connect: { title: "网络连接 Codex", description: "填写 Agent 地址和 Token，默认自动发现，失败后再手动填写。", disconnect: "断开", connect: "连接", address: "连接地址", urlPlaceholder: "例如 http://127.0.0.1:17371", token: "连接 Token", tokenPlaceholder: "自动发现，或手动填入 Connect token" },
