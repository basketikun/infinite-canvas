export default {
    ...
    canvas: {
        ...
        emptyState: { title: "从一个研究问题开始", description: "把模糊兴趣放进画布，逐步形成方向、问题、方法与可验证的 Idea。", seed: "创建 Seed", seedDescription: "记录最初的研究兴趣", text: "添加文本", textDescription: "写下材料、观察或备注", import: "导入素材", importDescription: "添加图片、视频或音频", agent: "与 Agent 对话", agentDescription: "让 Agent 帮你展开第一步", hint: "也可以双击画布空白处创建节点" },
        project: {
        ...
        sidePanel: {
            canvas: "画布元素", assets: "资产库", workspace: "研究工作区", startCreating: "开始创作", projectLibrary: "项目库", skillsConnectors: "技能 · 连接器", projects: "项目", workspaceName: "CoResearch 研究", resize: "调整左侧面板宽度", elements: "画布元素", select: "选择", searchNodes: "搜索节点", focusNode: "定位到节点", preview: "放大预览", noNodes: "画布暂无节点", clearAll: "取消全选", selected: "已选 {{count}}", exporting: "正在导出选中元素…", exportName: "画布元素-{{count}}个", exported: "已导出 {{count}} 个元素", exportFailed: "导出失败，请重试",
    ...
    agent: {
        ...
        connect: { title: "网络连接 Codex", description: "本机 Canvas Agent 在线时会自动发现并连接；失败后再手动填写地址和 Token。", disconnect: "断开", connect: "连接", address: "连接地址", urlPlaceholder: "例如 http://127.0.0.1:17371", token: "连接 Token", tokenPlaceholder: "自动发现，或手动填入 Connect token" },
        ...
        panel: { connectionSettings: "连接设置 · {{status}}", connectionSettingsLabel: "连接设置，当前{{status}}", chat: "对话", connection: "连接", settings: "Agent 设置", settingsLabel: "打开 Agent 设置", settingsTitle: "Agent 设置", history: "历史", skills: "技能", logs: "日志", collapse: "收起对话", collapseLabel: "收起 Agent 面板", resize: "调整右侧面板宽度", content: "Agent 内容", mcpInitializing: "MCP 初始化中，完成后即可发送", initFailed: "Codex 对话初始化失败，请新建或恢复对话", placeholder: "询问 Codex，输入 / 使用技能，@ 引用画布素材" },
        chat: { welcome: "你好，{{name}}", welcomeDescription: "从当前研究项目开始，我们一起把想法放到画布上。", latestMessages: "查看最新消息", latestCall: "最新调用", input: "输入", cached: "缓存", output: "输出" },
    ...
    auth: { title: "登录 Research Canvas", account: "账号", password: "密码", signIn: "登录", signOut: "退出登录", signedIn: "已登录", testAccountHint: "内置测试账号：test，密码：12345678", failed: "认证失败" },
    locale: {
        zhCN: "简体中文",
        enUS: "English",
    },
