export default {
    ...
    theme: { toggle: "切换主题" },
    desktop: { credentialsFailed: "无法读取 Windows 凭据库", updateTitle: "发现新版本 {{version}}", updateDescription: "新版本已可用。确认后将下载更新并重启应用。", updateNow: "更新并重启", updateLater: "稍后" },
    common: {
        cancel: "取消",
        save: "保存",
        edit: "编辑",
    ...
    config: {
        ...
        exportSecurityTitle: "导出的文件包含明文凭据",
        exportSecurityWarning: "配置文件会包含所有渠道 API Key 和 WebDAV 密码。请只保存到可信位置，不要上传或转发。",
        import: "导入配置",
        export: "导出配置",
        imported: "配置与用户偏好已导入",
        ...
        channelEditor: {
            ...
            protocol: "协议",
            baseUrl: "接口地址",
            httpWarning: "这是非本机 HTTP 地址。桌面版可以直接访问，但 API Key 和请求内容不会被传输加密。",
            models: "渠道模型",
            modelDescription: "已选 {{count}} 个；为每个模型指定能力并可自定义调用脚本。",
            selectModels: "选择模型",
            selectCapabilities: "选择一个或多个能力",
            scriptReady: "脚本已设",
            script: "调用脚本",
