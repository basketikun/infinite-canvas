export default {
    ...
    seedance: {
        ...
        errors: { format: "{{label}} 仅支持 mp4/mov 格式", size: "{{label}} 超过 200MB，请压缩后再上传", duration: "{{label}} 时长需要在 2-15 秒之间", dimensions: "{{label}} 宽高需要在 300-6000px 之间", ratio: "{{label}} 宽高比需要在 0.4-2.5 之间", pixels: "{{label}} 总像素需要在 409600-8295044 之间", totalDuration: "Seedance 参考视频总时长不能超过 15 秒" },
    },
    modelPlugin: {
