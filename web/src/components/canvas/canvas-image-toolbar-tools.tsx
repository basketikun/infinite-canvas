...
export type ImageQuickToolId = "document" | "info" | "delete" | "saveAsset" | "download" | ImageNodeActionToolId;
...
const defaultBaseToolIds: ImageQuickToolId[] = ["document", "info", "delete", "saveAsset", "download"];
