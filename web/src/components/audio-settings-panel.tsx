    ...
    return (
        <ImageSettingsTheme theme={theme}>
            <div className={className} style={{ color: theme.node.text }} onMouseDown={(event) => event.stopPropagation()}>
                {showTitle ? <div className="text-lg font-semibold">{t("audioSettings.title")}</div> : null}
                <SettingGroup title={t("audioSettings.voice")} color={theme.node.muted}>
                ...
                <SettingGroup title={t("audioSettings.format")} color={theme.node.muted}>
                    <div className="grid grid-cols-3 gap-2.5">
                ...
                <SettingGroup title={t("audioSettings.speed")} color={theme.node.muted}>
                ...
                <SettingGroup title={t("audioSettings.instructions")} color={theme.node.muted}>
                    <textarea
                        value={config.audioInstructions || ""}
                        placeholder={t("audioSettings.instructionsPlaceholder")}
