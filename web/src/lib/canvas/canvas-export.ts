...
export async function exportCanvasProjects(projects: CanvasProject[], fileName = "Cozy Tv") {
    ...
    const data: CanvasExportFile = { app: "cozy-tv", version: 3, exportedAt: new Date().toISOString(), projects: exportedProjects };
