...
import { useNavigationTools } from "@/constant/navigation-tools";
...
export default function IndexPage() {
    ...
    useEffect(() => {
        let cancelled = false;
        void import("@/services/api/prompts")
            .then(({ fetchPrompts }) => fetchPrompts({ pageSize: 12 }))
            .then((data) => {
                ...
                <div className="relative flex min-h-[620px] flex-col items-center justify-center pt-10 text-center">
                    ...
                    <p className="mt-8 max-w-3xl text-balance text-lg leading-8 text-stone-500 dark:text-stone-400">
                        ...
                        <Highlighter action="underline" color="#FF9800">
                            {t("home.subtitleHighlightCanvas")}
                        </Highlighter>
                        {t("home.subtitleMiddle")}
                        <Highlighter action="highlight" color="#87CEFA">
                            {t("home.subtitleHighlightContent")}
                        </Highlighter>
