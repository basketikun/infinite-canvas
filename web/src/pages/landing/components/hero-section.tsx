                ...
                <div className="grid items-center gap-12 lg:grid-cols-12">
                    ...
                    <div className="text-center lg:col-span-6 lg:text-left">
                        ...
                        <motion.div
                            ...
                            className="inline-flex items-center gap-2 rounded-full border border-orange-500/30 bg-orange-500/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-orange-400 backdrop-blur-md shadow-lg shadow-orange-500/10"
                        >
                            <Sparkles className="size-3.5" /> 无界创作 · 自由拓扑 AI 工作台
                        </motion.div>
                        ...
                        <motion.h1
                            ...
                            className="mt-6 text-4xl font-black tracking-tight sm:text-5xl lg:text-6xl leading-[1.15]"
                        >
                        ...
                        >
                            <Link
                                to="/canvas"
                                className="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-2xl bg-gradient-to-r from-orange-500 to-amber-500 px-8 py-4 text-base font-bold text-stone-950 shadow-xl shadow-orange-500/25 transition-all duration-300 hover:scale-105 hover:shadow-orange-500/40 active:scale-95 w-full sm:w-auto"
                            >
                            ...
                            <a
                                href="#features"
                                className="inline-flex items-center justify-center gap-2 rounded-2xl border border-stone-700 bg-stone-900/80 px-7 py-4 text-base font-semibold text-stone-200 backdrop-blur-md transition-all duration-300 hover:border-stone-500 hover:bg-stone-800 hover:text-white w-full sm:w-auto"
                            >
