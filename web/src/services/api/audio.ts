...
function assertAudioConfig(config: AiConfig, model: string) {
    ...
    if (config.channelMode === "remote" ? !useUserStore.getState().token : !config.apiKey.trim()) throw new Error(config.channelMode === "remote" ? apiText("authenticationFailed") : apiText("apiKeyRequired"));
