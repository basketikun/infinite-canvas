...
export const toolInputSchemas = {
    ...
    comfyui_run: z.object({ preset: z.string(), input: recordSchema.optional(), params: recordSchema.optional() }),
    comfyui_get_task: z.object({ taskId: z.string() }),
    comfyui_cancel_task: z.object({ taskId: z.string() }),
    ...
    assets_list: z.object({ kind: z.enum(["all", "text", "image", "video", "audio"]).optional(), keyword: z.string().optional(), page: z.number().optional(), pageSize: z.number().optional() }),
...
export const toolDescriptions: Record<ToolName, string> = {
    ...
    comfyui_run: "运行本地 ComfyUI 内置预设；输入必须是 Agent 已知的本地媒体引用。",
