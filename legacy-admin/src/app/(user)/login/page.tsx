            ...
            <section className="w-full max-w-[420px]">
                <div className="mb-7 text-center">
                    <span
                        ...
                        style={{
                            mask: "url(/admin-assets/logo.svg) center / contain no-repeat",
                            WebkitMask: "url(/admin-assets/logo.svg) center / contain no-repeat",
                        }}
                        aria-label="无限画布"
                    />
                ...
                <Form<LoginFormValues> layout="vertical" size="large" requiredMark={false} onFinish={submit}>
                    ...
                    <Space orientation="vertical" size={12} style={{ width: "100%" }}>
                        ...
                        {linuxDoEnabled ? (
                            <Button block href={`/api/auth/linux-do/authorize?redirect=${encodeURIComponent(redirect)}`} icon={<img src="/admin-assets/icons/linuxdo.svg" alt="" width={18} height={18} />}>
                                使用 Linux.do 登录
                            </Button>
                        ) : null}
                    </Space>
