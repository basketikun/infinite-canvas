...
CoResearch is in active development. Security fixes are accepted for the
...
2. If a private GitHub report is not available, email `zhanghoks@gmail.com` with
   the subject `[coresearch security]`.
